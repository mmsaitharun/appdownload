...
public class InitialHereTabs {
	...
	public String toString() {
		return "InitialHereTabs [name=" + name + ", tabLabel=" + tabLabel + ", anchorString=" + anchorString
				+ ", anchorIgnoreIfNotPresent=" + anchorIgnoreIfNotPresent + ", anchorXOffset=" + anchorXOffset
				+ ", anchorYOffset=" + anchorYOffset + ", anchorUnits=" + anchorUnits + ", anchorCaseSensitive="
				+ anchorCaseSensitive + ", anchorMatchWholeWord=" + anchorMatchWholeWord
